...
var setUpPushMessaging = function(newMode) {
    ...
    setUpDropZone('messaging-content-right', 'push-drop-zone', function(file) {
...
var setUpMeDevicePicker = function() {
    document.getElementById('me-device').placeholder = text.get('devices_placeholder');
...
var setUpPushStreams = function() {
    ...
    if (mode == 'devices') {
        var allDevicesRow = function() {
            var name = text.get('all_of_my_devices');
    ...
    if (mode != 'devices') {
       var addFriendRow = function() {
            var name = text.get('add_a_friend');
...
var setUpLinkAttacher = function() {
    ...
    linkTitle.placeholder = text.get('title_placeholder');
    linkUrl.placeholder = text.get('url_placeholder');
