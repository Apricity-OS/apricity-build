...
sudo scp out/* server@192.241.147.116:/mnt/static/public_html/freezedry-build/${username}/apricity_os-${iso_name}.iso
sudo scp logs/apricity_os-${iso_name}.log server@192.241.147.116:/mnt/static/public_html/freezedry-build/${username}/apricity_os-${iso_name}.log
