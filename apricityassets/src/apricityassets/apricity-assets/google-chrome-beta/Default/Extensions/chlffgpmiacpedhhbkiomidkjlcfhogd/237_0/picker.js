...
picker.setUp = function(spec) {
    ...
    var hide = function() {
        if (!inputElement.target && lastTarget && (inputElement.id != 'sms-recipient' || !inputElement.value.trim())) {
...
var createRow = function(target) {
    ...
    img.src = utils.targetImageUrl(target);

    var nameDiv = document.createElement('div');
    nameDiv.className = 'picker-target-text';
    nameDiv.textContent = utils.targetDisplayName(target);
