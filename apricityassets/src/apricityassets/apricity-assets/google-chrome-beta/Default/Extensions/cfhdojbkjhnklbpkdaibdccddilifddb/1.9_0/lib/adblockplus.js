  ...
  var Notification = exports.Notification = {
    ...
    getNextToShow: function(url)
    {
      ...
      for (var _loopIndex35 = 0; _loopIndex35 < notifications.length; ++_loopIndex35)
      {
        ...
        {
          if (Prefs.notificationdata.shown.indexOf(notification.id) !== -1 || Prefs.notifications_ignoredcategories.indexOf("*") !== -1)
          {
            continue;
          }
        }
...
require.scopes["filterValidation"] = (function()
{
  ...
  exports.parseFilters = function(text)
  {
    ...
    for (var i = 0; i < lines.length; i++)
    {
      var _tempVar45 = parseFilter(lines[i]);
      var filter = _tempVar45.filter;
      var error = _tempVar45.error;
      if (filter)
      {
        filters.push(filter);
      }
...
{
  var exports = {};
  var _tempVar46 = require("url");
  var extractHostFromFrame = _tempVar46.extractHostFromFrame;
  var stringifyURL = _tempVar46.stringifyURL;
  var isThirdParty = _tempVar46.isThirdParty;
  var _tempVar47 = require("whitelisting");
  var getKey = _tempVar47.getKey;
  var isFrameWhitelisted = _tempVar47.isFrameWhitelisted;
  var defaultMatcher = require("matcher").defaultMatcher;
  ...
  exports.composeFilters = function(details)
  {
    ...
    if (!isFrameWhitelisted(page, frame, "DOCUMENT"))
    {
      ...
      for (var _loopIndex48 = 0; _loopIndex48 < details.urls.length; ++_loopIndex48)
      {
        var url = details.urls[_loopIndex48];
      ...
      if (filters.length == 0 && !isFrameWhitelisted(page, frame, "ELEMHIDE"))
      {
        ...
        for (var _loopIndex49 = 0; _loopIndex49 < selectors.length; ++_loopIndex49)
        {
          var selector = selectors[_loopIndex49];
...
{
  var exports = {};
  var _tempVar50 = require("icon");
  var startIconAnimation = _tempVar50.startIconAnimation;
  var stopIconAnimation = _tempVar50.stopIconAnimation;
  var Utils = require("utils").Utils;
  ...
  var showNextNotification = exports.showNextNotification = function(url)
  {
    var notification = NotificationStorage.getNextToShow(url && stringifyURL(url));
